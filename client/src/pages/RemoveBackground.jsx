...
const RemoveBackground = () => {
    ...
    gap-4 text-slate-700'>
       ...
       border-gray-200 '>
        ...
        <input onChange={(e)=>setInput(e.target.files[0])}   type="file" accept='image/*' className='w-full p-2 px-3 mt-2 outline-none text-sm
         ...
         <p className='text-xs text-gray-500 font-light mt-1'>Suppports JPG,PNG,and other image formats</p>

        <button className='w-full flex items-center justify-center gap-2
        bg-gradient-to-r from-[#F6AB41] to-[#FF438] text-white px-4 py-2
  ...
  <div className='flex-1 flex justify-center items-center'>
    <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
      ...
      <p>upload an image and click "Generate Titles"to get started</p>
    </div>
  </div>
